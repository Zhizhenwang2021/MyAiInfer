//
// Created by lx186 on 2024/12/12.
//

#ifndef  MYINFER_INCLUDE_OP_ENCODE_H
#define  MYINFER_INCLUDE_OP_ENCODE_H
...
#if defined (LLAMA3_SUPPORT) || defined (QWEN2_SUPPORT)
cass BpeEncodeLayer : public EncodeLayerBase{
public:
...
#endif // MYINFER_INCLUDE_OP_ENCODE_H
