//
// Created by lx186 on 2024/11/25.
//

#ifndef MYINFER_INCLUDE_TENSOR_TENSOR_H_
#define MYINFER_INCLUDE_TENSOR_TENSOR_H_
...
public:
    ...
    explicit Tensor(base::DataType data_type, int32_t dim0, int32_t dim1, int32_t dim2,
        bool need_alloc = false, std::shared_ptr<base::DeviceAllocator> alloc = nullptr, void* ptr = nullptr);
    ...
    template <typename T>
    const T* ptr(int64_t offset) const;
...
#endif //MYINFER_INCLUDE_TENSOR_TENSOR_H_
